...
print('\nName and score columns in rows 1, 3, 5, 6:\n', df.iloc[[1,3,5,6],[1,3]])
...
attempts_greater_2 = df['attempts'] > 2
print('\nRows where the number of attempts is greater than 2:\n',df[attempts_greater_2])
...
above15 = df['score'] > 15
below20 = df['score'] <= 20
score_bet_15_20 = df[above15 & below20]
print('\nRows with score between 15 and 20:\n',score_bet_15_20)
...
df_sorted = df_sorted.sort_values(['attempts','name'], ascending=[True,True])
print('\nData Frame sorted by attempts and name:\n', df_sorted)
